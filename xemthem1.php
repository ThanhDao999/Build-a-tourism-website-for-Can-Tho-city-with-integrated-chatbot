            ...
            <ul>
                <?php
                    ...
                    if(isset($_SESSION['admin']) && $_SESSION['admin']  == 'admin'){
                        ...
                        echo "<li><a data-scroll='log in'>Đăng xuat</a></li>";
                    ...
                    while($row=$result->fetch_assoc()){
                        ...
                        <tr>
                            <td style='text-align: right'>
                                Địa chỉ:  '".$row['dia_chi_1']."'
                            </td>
                        </tr>

                        <tr>
                            <td style='text-align: right'>
                                Số điện thoai liên hệ: '".$row['so_dien_thoai_1']."'
                            </td>
                        </tr>

                        <tr>
                            <td style='text-align: right'>
                            Trang web liên hệ của địa điểm: '".$row['trang_web_1']."'
                            </td>
                        </tr>

                        <tr>
                            <td style='text-align: right'>
                                Người viết bài(Nguồn): '".$row['nguoi_viet_nguon_viet_1']."';
                            </td>
                        </tr>
